  ...
  public void periodic() {
    ...
    for (int i = 0; i <= results.size(); i++) {
      ...
      for (int p = 0; p <= targets.size(); p++) {
        ...
        Logger.recordOutput("Vision/ObjectsDetected/Area", area);
        Logger.recordOutput("Vision/ObjectsDetected/Yaw", yaw);
        Logger.recordOutput("Vision/ObjectsDetected/Pitch", pitch);
      }
    }
  }
}
