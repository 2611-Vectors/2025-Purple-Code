...
public class DriveCommands {
  ...
  public static void robotRelativeDrive(Drive drive,
      double xSupplier,
      double ySupplier,
        ...
        Commands.run(
            ...
            .finallyDo(
                () -> {
                  ...
                  SmartDashboard.putString("Calculated kS", formatter.format(kS));
                  SmartDashboard.putString("Calculated kV", formatter.format(kV));
                }));
  }
